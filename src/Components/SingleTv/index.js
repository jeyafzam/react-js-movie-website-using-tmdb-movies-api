...
import "../../Components/SingleMovie/style.css";
...
const SingleTV = () => {
  ...
  useEffect(() => {
    ...
    TokenAndBaseUrl.get(`/tv/${TvId}/videos`)
      .then((response) => {
    ...
    TokenAndBaseUrl.get(`/tv/${TvId}/credits`)
      .then((response) => {
    ...
    TokenAndBaseUrl.get(`/tv/${TvId}/similar`)
      .then((response) => {
    ...
    // Fetch reviews
    TokenAndBaseUrl.get(`/tv/${TvId}/reviews`)
      .then((response) => {
    ...
    // Fetch photos
    TokenAndBaseUrl.get(`/tv/${TvId}/images`)
      .then((response) => {
